...
export function getHideMessage(specialData: Record<string, any> | null | undefined): string | null {
...
export function buildTrophySpecialData(args: {
  special: Record<string, any> | null;
  objectRecord: Record<string, any> | null;
  inputName?: string;
  variant?: Record<string, any> | null;
  hideMessage?: string | null;
}): TrophySpecialData {
  const { special, objectRecord, inputName, variant, hideMessage } = args;
  const effect = (special?.variants as Record<string, any> | null)?.effect ?? variant?.effect ?? null;
...
export function getTrophyDisplayName(specialData: Record<string, any> | null | undefined): string {
...
export function getTrophyDisplayIcon(specialData: Record<string, any> | null | undefined): string {
...
export function getSpecialEffectDescriptor(special: Record<string, any> | null) {
  const variants = special?.variants as Record<string, any> | null;
  return {
